...
<html lang="en">
	...
	?>
		<div class="container  mt-1 border border-secondary mb-1">
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>BE Complition Date:</h5> <?php echo $row['ba_complition_date']  ?></div>
				<div class="col-md-4"><h5>BE Awarded Date:</h5> <?php echo $row['ba_awarded_date']  ?></div>
				<div class="col-md-4"><h5>BE Certificate:</h5> <?php echo $row['ba_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>ME Complition Date:</h5> <?php echo $row['ma_complition_date']  ?></div>
				<div class="col-md-4"><h5>ME Awarded Date:</h5> <?php echo $row['ma_awarded_date']  ?></div>
				<div class="col-md-4"><h5>ME Certificate:</h5> <?php echo $row['ma_certificate']  ?></div>
			</div>
		</div>
	<?php } ?>
</body>
